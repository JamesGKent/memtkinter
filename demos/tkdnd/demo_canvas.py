...
file_icon = tk.PhotoImage(data=file_data)
folder_icon = tk.PhotoImage(data=folder_data)

canvas = tk.Canvas(root, name='dnd_demo_canvas', bg='white', relief='sunken',
...
canvas.drag_source_register(1, tkdnd.DND_FILES)
