...
text = tk.Text(root, name='dnd_demo_text', wrap='word', undo=True, width=1, height=1)
text.grid(row=1, column=1, pady=5, sticky='news')

listbox.insert(tk.END, os.path.abspath(__file__))
...
listbox.drop_target_register(tkdnd.DND_FILES, tkdnd.DND_TEXT)
...
listbox.drag_source_register(1, tkdnd.DND_TEXT, tkdnd.DND_FILES)
text.drag_source_register(3, tkdnd.DND_TEXT)
